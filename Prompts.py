...
class Prompts:
    ...
    IMPORTENT: 
    'DO NOT ADD CONTENT CAN NOT REDUCE CONTENT THE SIZE OF BOTH INPUT AND OUTPUT MUST BE SIMILAR' 
...
class Prompts2:
    ...
    Example:
    Input: "John's credit card 4111-1111-1111-1111 has a balance of $5,000. His checking account 123456789 at XYZ Bank shows a balance of $10,500. Last month, he earned $7,500 and paid $2,000 in rent. His Adhar is 123-45-67898745632."

    Output: "John's credit card ****-*****-****-**** has a balance of $****. His checking account ********* at *** Bank shows a balance of ******. Last month, he earned **** and paid **** in rent. His Adhar is ***************."
